...
import 'package:busca_patas/publico/esqueceu-senha.dart';
import 'package:busca_patas/publico/nao-implementado.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class Login extends StatefulWidget {
  final VoidCallback mostrarTelaRegistro;
  final String title;

  const Login({super.key, required this.mostrarTelaRegistro, required this.title});
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            InkWell(
              onTap: widget.mostrarTelaRegistro
              // () {
              //   Navigator.push(
              //     context,
              //     MaterialPageRoute(
