...
class _CadastroPostState extends State<CadastroPost> {
        ...
        child: Column(
          ...
          children: [
            ...
            RadioListTile(
              ...
              onChanged: (value) {
                setState(() {
                  grupoColeira = value.toString().toLowerCase();
                });
              },
            ),
            RadioListTile(
  ...
  void _cadastrarAnimal(){
    _detalhesAnimal(
      ...
      coleiraController.text,
      recompensaController.text,
      lartemporarioController.text,
    );  
  }

  Future _detalhesAnimal(String nome, 
                          String raca, 
                          String especie, 
                          String sexo, 
                          //String cores,
  ...
  void dispose() {
    ...
    coleiraController.dispose();
    recompensaController.dispose();
    lartemporarioController.dispose();
    super.dispose();
  }
