import 'package:busca_patas/cadastros/cadastro-post.dart';
    ...
    // } else{
      return Scaffold(
        ...
        body:SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              Text("Logado como: ${usuario.email!}\n\nPágina inicial ainda não implementada", style: TextStyle(color: Color.fromARGB(255, 126, 107, 107),fontSize: 20)),
